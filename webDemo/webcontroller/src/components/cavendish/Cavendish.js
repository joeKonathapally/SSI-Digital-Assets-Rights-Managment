...
function Cavendish() {
  const API_URL = process.env.REACT_APP_CAVENDISH_API;
  const HOOK_URL = process.env.REACT_APP_CAVENDISH_HOOK;
    ...
    <>
      ...
      >
        {/* <Tab eventKey="home" title="Home">
          <Home api_url={API_URL} hook_url={HOOK_URL} />
        </Tab> */}
